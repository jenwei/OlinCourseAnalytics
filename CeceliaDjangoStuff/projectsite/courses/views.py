...
def compare(request):
	...
	if error != 'NONE':
		...
		return render(request, 'courses/mainpage.jade',{'maleratio':ratio['males'],'femaleratio':ratio['females'],'male1ratio':ratio1['males'],'female1ratio':ratio1['females'],'cc0stuCount': cc0stuCount, 'cc1stuCount':cc1stuCount})

...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for point in datapoints:
            p = orm.Datapoint.objects.create(id=dpid,courseid=point.course,stuid=point.stuID,stugen=point.stuGen,stumaj=point.stuMaj,stusem=point.stuSem,gradyear=point.gradYear,profid=point.prof) 
            p.save()            
            ...
            if point.course not in coursearchive:
                c = orm.Course.objects.create(id=point.course,name=OrganizeData.courses[point.course])
                c.save()

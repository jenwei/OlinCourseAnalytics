...
from sdfinal.seedcode.OrganizeData import *
from sdfinal.seedcode.Professor import *
from sdfinal.seedcode.parse_course_data import *
from sdfinal.seedcode.moreParseData import *

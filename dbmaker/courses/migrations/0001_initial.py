...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Datapoints', (
            ...
            ('coursename', self.gf('django.db.models.fields.TextField')(db_column='CourseName')),
            ...
            ('profname', self.gf('django.db.models.fields.TextField')(db_column='ProfName')),
            ('coursetitle', self.gf('django.db.models.fields.TextField')(db_column='CourseTitle')),
        ))
